...
class _Parser {
  ...
  HexColorTerm _parseHex(String hexText, SourceSpan span) {
    ...
    switch(hexText.length ){
      case 1:
        hexText = "ff" + hexText + hexText + hexText + hexText + hexText + hexText;
        break;
      case 2:
        hexText = "ff" + hexText + hexText + hexText;
        break;
      case 3:
        hexText = 'ff${hexText[0]}${hexText[0]}${hexText[1]}${hexText[1]}${hexText[2]}${hexText[2]}';
        break;
      case 4:
        hexText = '${hexText[0]}${hexText[0]}${hexText[1]}${hexText[1]}${hexText[2]}${hexText[2]}${hexText[3]}${hexText[3]}';
        break;     
      case 6:
        hexText = "ff" + hexText;
        break;
